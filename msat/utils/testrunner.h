#ifndef MSAT_TESTSRUNNER_H
#define MSAT_TESTSRUNNER_H
...
struct SimpleTestController : public FilteringTestController
{
    ...
    SimpleTestController(msat::term::Terminal& output);
...
struct VerboseTestController : public FilteringTestController
{
    ...
    VerboseTestController(msat::term::Terminal& output);
...
struct TestResultStats
{
    ...
    void print_results(msat::term::Terminal& out);
    void print_stats(msat::term::Terminal& out);
    void print_summary(msat::term::Terminal& out);
};
