...
SimpleTestController::SimpleTestController(msat::term::Terminal& output)
    : output(output)
{
}
...
VerboseTestController::VerboseTestController(msat::term::Terminal& output)
    : output(output) {}
...
struct Title
{
    ...
    Title(msat::term::Terminal& output, const std::string& title)
