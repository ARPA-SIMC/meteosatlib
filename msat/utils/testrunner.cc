...
SimpleTestController::SimpleTestController(msat::term::Terminal& output_)
    : output(output_)
{
}
...
VerboseTestController::VerboseTestController(msat::term::Terminal& output_)
    : output(output_) {}
...
struct Title
{
    msat::term::Terminal& output;
    std::string title;
    bool printed = false;

    Title(msat::term::Terminal& output_, const std::string& title_)
...
void TestResultStats::print_results(msat::term::Terminal& out)
{
...
void TestResultStats::print_stats(msat::term::Terminal& out)
{
...
void TestResultStats::print_summary(msat::term::Terminal& out)
{
